...
class DataTransformation:
    def __init__(self):
        self.data_transformation_config = DataTransformationConfig()  # Correct initialization
    ...
    def get_data_transformer_object(self):
        try:
            ...
            logging.info('Standardizing the numerical features done')
    ...
    def initiate_data_transformation(self, train_path, test_path):
        try:
            ...
            logging.info("Reading the train test data completed")
